...
var _user$project$Nim$addMatch = F2(
	function (row, model) {
		var _p0 = model.currentMatches;
		if (_p0 === 0) {
			return model;
		} else {
			var matches = model.currentMatches - 1;
			var currentRow = _elm_lang$core$Native_Utils.eq(matches, 0) ? _elm_lang$core$Maybe$Nothing : model.currentRow;
			var newBoard = A2(
				_elm_lang$core$List$indexedMap,
				F2(
					function (i, x) {
						return _elm_lang$core$Native_Utils.eq(i, row) ? (x + 1) : x;
					}),
				model.board);
			return _elm_lang$core$Native_Utils.update(
				model,
				{board: newBoard, currentMatches: matches, currentRow: currentRow});
		}
	});
var _user$project$Nim$setUndoButtonDisabled = F2(
...
var _user$project$Nim$incrementMatches = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{currentMatches: model.currentMatches + 1});
};
var _user$project$Nim$addText = F2(
...
var _user$project$Nim$removeCurrentRow = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{currentRow: _elm_lang$core$Maybe$Nothing});
};
var _user$project$Nim$firstWinnerMove = F2(
	function (list, index) {
		firstWinnerMove:
		while (true) {
			var _p3 = list;
...
var _user$project$Nim$winnerNumber = F2(
	function (sum, matches) {
		var result = matches ^ sum;
		return (_elm_lang$core$Native_Utils.cmp(result, matches) < 0) ? _elm_lang$core$Maybe$Just(matches - result) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Nim$get = F2(
	function (index, list) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, index, list));
	});
var _user$project$Nim$filterIndex = F4(
...
var _user$project$Nim$rowsWithMatches = function (model) {
	return A4(
		_user$project$Nim$filterIndex,
		function (n) {
...
var _user$project$Nim$findIndex_ = F3(
...
var _user$project$Nim$findIndex = F2(
...
var _user$project$Nim$addSmile = function (model) {
	return _user$project$Nim$noWinnerMove(model.board) ? _elm_lang$core$Native_Utils.update(
		model,
		{
			...
			A2(
				...
				A2(
					...
					_user$project$Nim$humanPlays(
						_user$project$Nim$removeCurrentRow(model))))));
};
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				board: A2(
					...
					F2(
						function (i, x) {
							return _elm_lang$core$Native_Utils.eq(i, row) ? (x - matches) : x;
						}),
					model.board)
			});
	});
...
var _user$project$Nim$randomMove = F2(
	function (index, model) {
		var rows = _user$project$Nim$rowsWithMatches(model);
		var row = A2(_user$project$Nim$get, index, rows);
		return A2(
			_user$project$Nim$removeMatch,
			A2(_elm_lang$core$Maybe$withDefault, 0, row),
			model);
	});
		...
		switch (_p11.ctor) {
				...
				if ((_p12.ctor === 'Just') && (_p12._0 === false)) {
					...
					if (_user$project$Nim$noWinnerMove(model.board)) {
						var rows = _elm_lang$core$List$length(
							_user$project$Nim$rowsWithMatches(model)) - 1;
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(
								...
								A2(_elm_lang$core$Random$int, 0, rows))
						};
					} else {
						return {
							ctor: '_Tuple2',
			...
			case 'RandomRow':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Nim$afterComputerMoves(
						A2(_user$project$Nim$randomMove, _p11._0, model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Undo':
				return {
...
var _user$project$Nim$rowContent = F2(
					...
					return A2(
						_elm_lang$html$Html$img,
						{
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Nim$RemoveMatch(row)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('img/match.png'),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('twelve column'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							F2(
								function (row, elements) {
									return A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$Nim$rowContent, row, elements),
											_1: {ctor: '[]'}
										});
								}),
							model.board)),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Nim$Restart),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Nim$Undo),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$disabled(model.undoButtonDisabled),
													_1: {ctor: '[]'}
												}
											},
											{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Nim$ComputerMoves),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$disabled(model.nextPlayerButtonDisabled),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(_user$project$Nim$nextButtonTitle),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$Nim$main = _elm_lang$html$Html$program(
	{
...
var Elm = {};
Elm['Nim'] = Elm['Nim'] || {};
if (typeof _user$project$Nim$main !== 'undefined') {
    _user$project$Nim$main(Elm['Nim'], 'Nim', undefined);
}
